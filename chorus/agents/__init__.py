...
if TYPE_CHECKING:
    ...
    from chorus.agents.supervisor import CREATE_PLAN_TOOL_SCHEMA, ChatModelEntry, SupervisorService
...
def __getattr__(name: str):
    ...
    __getattr__ 延迟到首次访问时导入，re-export 语义不变（from chorus.agents import
