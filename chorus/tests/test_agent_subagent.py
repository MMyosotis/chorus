...
def _setup():
    ...
    return conn, msg_svc, trace_svc, task_repo, art_repo, steps_repo
...
def test_subagent_idea_awaiting_confirm():
    ...
    conn, msg_svc, trace_svc, task_repo, art_repo, steps_repo = _setup()
    ...
    sub = _build_subagent(conn, msg_svc, trace_svc, task_repo, art_repo, steps_repo, client)
    sub.run("t1")
