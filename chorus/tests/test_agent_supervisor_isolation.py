...
from chorus.tools.builtin import BaiduSearchTool, CreatePlanTool, LoadSkillTool, PresentOptionsTool, UpdateIntentStateTool
...
def _registry() -> ToolDispatch:
    ...
    return ToolDispatch([
        ...
        CreatePlanTool(None, None, None, None, None),
