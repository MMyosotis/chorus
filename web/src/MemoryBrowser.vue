...
.memory-list { min-height: 0; flex: 1; display: flex; flex-direction: column; gap: var(--ch-space-1); overflow-y: auto; }.memory-item { width: 100%; display: flex; flex-direction: column; gap: var(--ch-space-1); padding: var(--ch-space-2); border: 0; border-radius: var(--ch-radius-list); background: transparent; color: var(--ch-text); text-align: left; cursor: pointer; }.memory-item:hover { background: var(--ch-surface-2); }.memory-item.active { background: var(--ch-accent-soft-gradient); }.memory-item strong { overflow: hidden; font-size: var(--ch-text-sm); font-weight: var(--ch-font-semibold); text-overflow: ellipsis; white-space: nowrap; }.memory-item.active strong { color: var(--ch-accent); font-size: var(--ch-text-sm); }.memory-item small { overflow: hidden; color: var(--ch-text-faint); font-size: var(--ch-text-xs); text-overflow: ellipsis; white-space: nowrap; }.hint,.error-hint { margin: 0; padding: var(--ch-space-3) var(--ch-space-2); color: var(--ch-text-muted); font-size: var(--ch-text-sm); }.error-hint { color: var(--ch-danger-text); }
