...
- `test_repo_connection.py` / `test_repo_message.py` / `test_repo_trace.py` / `test_repo_task.py` / `test_repo_task_artifacts.py` / `test_repo_task_progress.py` / `test_repo_task_content.py` / `test_repo_row_contract.py` — 各 repo 的 smoke test（哑查询 / cancel_pipeline / 多来源 trace / row 契约等）
