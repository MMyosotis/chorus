...
__all__ = ["AgentContext", "LoopOutcome", "TurnState", "SubAgentService", "TaskScheduler"]


def __getattr__(name: str):
    """懒加载 SubAgentService / TaskScheduler 以破循环导入。
    ...
    SubAgentService 仍可用），环被打破。scheduler 同此约束（Task 4）。supervisor
    （计划 2 Task 5）同此约束。
    """
